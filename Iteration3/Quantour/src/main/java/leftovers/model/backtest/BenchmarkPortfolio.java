...
public class BenchmarkPortfolio {
    ...
    public BenchmarkPortfolio() {
    }

    public BenchmarkPortfolio(String date, double cash, double market_value, double total_value, double static_unit_net_value, double unit_net_value, double units) {
        this.date = date;
        this.cash = cash;
